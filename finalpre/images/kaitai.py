...
def main():
    ...
    screen = pygame.display.set_mode((1400, 1400))  # 画面を作成
    pygame.display.set_caption("My Voice Mate-Kuma")

    gamebutton = []
    gamebuttonrect = Rect(0, 0, 1400, 1400) # 画像の表示位置を表す矩形
    ...
    img1 = pygame.image.load("./images/regular.png")
    img2 = pygame.image.load("./images/smile.png")
    img3 = pygame.image.load("./images/angry.png")
    img1 = pygame.transform.scale(img1, (1300,1000))
    img2 = pygame.transform.scale(img2, (1300,1000))
    img3 = pygame.transform.scale(img3, (1300,1000))
