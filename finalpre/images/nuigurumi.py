...
def main():
    ...
    img1 = pygame.image.load("./images/sleep1.png")
    img2 = pygame.image.load("./images/regular1.png")
    img3 = pygame.image.load("./images/speak1.png")
    img4 = pygame.image.load("./images/angry1.png")
